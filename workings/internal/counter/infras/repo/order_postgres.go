...
import (
	...
	"github.com/hoangcn95/go-coffeeshop-imitate/workings/internal/counter/infras/postgresql"
...
var _ orderSvc.OrderRepo = (*orderRepo)(nil)

var RepositorySet = wire.NewSet(NewOrderRepo)

func NewOrderRepo(pg postgres.DBEngine) orderSvc.OrderRepo {
