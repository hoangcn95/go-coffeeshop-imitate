...
func (c *counterServiceClient) GetListOrderFulfillment(ctx context.Context, in *GetListOrderFulfillmentRequest, opts ...grpc.CallOption) (*GetListOrderFulfillmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.CounterService/GetListOrderFulfillment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *counterServiceClient) PlaceOrder(ctx context.Context, in *PlaceOrderRequest, opts ...grpc.CallOption) (*PlaceOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.CounterService/PlaceOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CounterService_GetListOrderFulfillment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CounterService/GetListOrderFulfillment",
	}
...
func _CounterService_PlaceOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CounterService/PlaceOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var CounterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.CounterService",
